(() => {
  ...
  const COMMON_ENTRIES = [
    ...
    { title: '유동성 풀', aliases: 'Liquidity Pool · 유동성 공급', detail: ['DEX에서 교환에 쓰도록 두 종류 이상의 토큰을 함께 예치해 둔 자금 바구니입니다. 이용자는 이 풀을 상대로 토큰을 교환하고, 공급자는 조건에 따라 수수료·보상을 받을 수 있습니다.', '유동성 공급은 단순 예금이 아닙니다. 두 토큰의 가격이 크게 다르게 움직이면 보유만 했을 때와 다른 손익(비영구적 손실)이 생길 수 있고, 풀·토큰·스마트계약의 위험도 남습니다.'] },
